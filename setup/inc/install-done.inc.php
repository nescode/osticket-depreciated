    ...
    <div id="main">
        ...
        <table border="0" cellspacing="0" cellpadding="5" width="580" id="links">
            <tr>
                ...
                <tr>
                    <td width="50%">
                        <strong><?php echo __('Nescode Forums');?>:</strong><Br>
                        <a href="#">http://nescode.com</a>
                    </td>
                    <td width="50%">
                        <strong><?php echo __('Nescode Community Wiki');?>:</strong><Br>
                        <a href="#">http://nescode.com</a>
                    </td>
                </tr>
            </table>
